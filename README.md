...
This package is generated from [`sabaatworld/ha-core`](https://github.com/sabaatworld/ha-core) at source revision `fac1df17e17e0074bffc3c1eec9487f757cab713` and published as `2026.7.2-v0.0.4`. HACS uses the GitHub Release for each published version to offer updates.
## ✨ Why LIFX Ultimate?
